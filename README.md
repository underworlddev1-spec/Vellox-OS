...
[Der große Bildschirm ist nicht die feste Fassung](04_UI/08-grosser-bildschirm-und-skalierung.md) trägt den Gegenpol dazu. Ein an einer Maximalbreite gedeckeltes rem-Layout hört an seinem letzten Breakpoint auf zu wachsen und wirkt auf großen Monitoren zu klein, ohne dass es im Bau um 1280 herum jemand sieht. Eine fließende Wurzel-Schriftgröße lässt Typografie, Abstände und Container gemeinsam mitwachsen, sofern die Breakpoints in Pixeln stehen und die Untergrenze ein rem bleibt.
