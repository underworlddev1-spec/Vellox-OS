...
Wie eine verkaufende Seite endet, steht in [Beweis, Abgrenzung, Handlung](04_UI/09-beweis-abgrenzung-handlung.md). Die Reihenfolge entscheidet dort mehr als der Inhalt der einzelnen Teile: Ein Beweis ohne Grenze bleibt Werbung, eine Grenze ohne Beweis ist nur Bescheidenheit, und eine Grenze NACH der Aufforderung ist kein Vorbehalt mehr, sondern Kleingedrucktes. Das Kapitel trägt außerdem die Prüfung, die dabei am häufigsten fehlt: Die Abgrenzung wird gegen den tatsächlichen Leistungsumfang gehalten, nicht gegen die Positionierung, sonst schickt die Seite zahlende Kunden zur Konkurrenz.
