...
Vier Regeln gelten in jeder gebauten Oberfläche und sind über mehrere Kapitel verteilt, weil sie verschiedene Ebenen betreffen. Farbe wird nach ihrer Aufgabe benannt und nicht nach ihrem Aussehen; die Palette ist die einzige Datei mit einem Farbwert darin, und was daraus für den Code folgt, steht in den [Coding Standards](07_ENGINEERING/01-coding-standards.md). Zugänglichkeit wird geprüft und nicht beansprucht, mit gerechnetem Kontrast, einem Durchlauf über jede ausgelieferte Seite und einer [rechtlichen Prüfung, die eine andere ist](07_ENGINEERING/04-accessibility-und-animation.md). [Wartezustände](04_UI/08-wartezustaende-und-skelette.md) haben vier Fälle und nicht zwei, und ein Skelett gehört nur dorthin, wo tatsächlich etwas lädt. Und jedes Element trägt die [Beweislast für sich selbst](04_UI/04-cards-content-surfaces.md), weil Hinzufügen immer einen Fürsprecher hat und Weglassen fast nie.
