...
Farbe lenkt Aufmerksamkeit. Typografie bestimmt Lesetempo und Gewicht. Abstände geben Informationen eine Rangordnung. Ein Formular kann eine Beziehung beginnen oder einen Besucher zurückschicken. Diese Dinge sind nicht bloß visuell. Sie verändern Verhalten, weil sie beeinflussen, was leicht, wichtig, glaubwürdig oder riskant erscheint.

Daraus folgt eine praktische Regel: Für jede sichtbare Entscheidung muss sich eine erwartete Reaktion benennen lassen. „Der CTA soll stärker auffallen“ ist zu unpräzise. „Der CTA soll nach dem Vertrauensabschnitt als eindeutigster nächster Schritt erkennbar sein, ohne den Beratungscharakter des Angebots zu verletzen“ ist prüfbar. Die Form kann danach gewählt werden.
...
## Die drei Fragen jeder Entscheidung

Erstens: **Welches menschliche Problem wird gelöst?** Das kann Orientierung, Zweifel, Überforderung, fehlende Relevanz oder fehlendes Vertrauen sein. Zweitens: **Welche geschäftliche Absicht unterstützt die Lösung?** Eine gute Erfahrung ist nicht neutral; sie hilft dem richtigen Angebot, mit den richtigen Menschen in Kontakt zu kommen. Drittens: **Wie erkennen wir später, dass die Entscheidung funktioniert?** Der Nachweis kann qualitativer Art sein, etwa ein verständlicher Nutzertest, oder quantitativer Art, etwa ein vollständig ausgefülltes Anfrageformular. Ohne Nachweis bleibt die Entscheidung Geschmack.
