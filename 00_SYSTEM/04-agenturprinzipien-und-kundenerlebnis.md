...
## Wir machen Arbeit sichtbar, nicht Lärm

Transparenz bedeutet nicht, jeden internen Gedanken ungefiltert zu übertragen. Sie bedeutet, dass Fortschritt an Artefakten und Entscheidungen erkennbar ist. Ein gutes Update beantwortet: Was wurde verstanden? Was wurde entschieden? Welche Frage ist offen? Was wird als Nächstes benötigt? Welche Konsequenz hat eine Verzögerung?

So wird Kommunikation selbst zu einer Benutzeroberfläche. Begriffe, Status und nächste Schritte müssen genauso klar sein wie auf der Website. Unklare Statusberichte erzeugen mentale Last und fördern spontane Richtungswechsel. Klare Updates geben dem Kunden die Möglichkeit, sich auf die wichtigen Entscheidungen zu konzentrieren.

## Wir schützen die Qualität vor dem Terminplan, ohne den Terminplan zu ignorieren

Nicht jede Qualität ist gleich teuer. Frühzeitige Klarheit reduziert späte Arbeit. Wenn Zeit knapp ist, wird zuerst der Kern geschützt: verständliche Positionierung, sauberer Hauptweg, belastbare Inhalte, Zugänglichkeit und technische Stabilität. Dekorative Vielfalt, Sonderanimationen und optionale Seiten können reduziert werden.

Diese Priorisierung wird offen erklärt. Ein Kunde soll nicht erst beim Launch merken, dass eine Entscheidung aus Zeitgründen vereinfacht wurde. Die [Entscheidungslogik](02-entscheidungsframework.md) hilft dabei, Abstriche als bewusste Produktentscheidungen zu behandeln und nicht als stille Verschlechterung.

## Wir behandeln Feedback als Evidenz, nicht als Befehl
...
Ein Kunde darf nicht dauerhaft auf die Agentur angewiesen sein, um kleine Änderungen sicher vorzunehmen. Übergaben erklären Content-Struktur, Komponenten, Zustände, Bildverwendung, SEO-Grundlagen und die Grenzen des Systems. Eine Dokumentation, die nur den Erstellern verständlich ist, ist keine Übergabe, sondern ein internes Gedächtnis.

Das [Projektbrief-Template](../09_TEMPLATES/01-projektbrief.md) und der [Launch-Check](../10_CHECKLISTS/06-launch.md) legen fest, welche Informationen nicht verloren gehen dürfen. Pflege ist Teil des Produkts, nicht eine nachträgliche Gefälligkeit.

## Wir arbeiten mit Respekt für Aufmerksamkeit

Respekt zeigt sich in kurzen Wegen, gut vorbereiteten Meetings und Entscheidungen, die nicht ohne Anlass wieder geöffnet werden. Intern bedeutet es, dass Review-Kommentare konkret sind und dass Menschen nicht für Systemlücken verantwortlich gemacht werden. Extern bedeutet es, dass wir Sprache, Daten und Zeit des Kunden sorgfältig behandeln.
