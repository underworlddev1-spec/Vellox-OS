...
**Und prüfe am großen Bildschirm, weil dort nichts bricht.** Ein Entwurf hört nicht bei der größten Bruchstelle des Frameworks auf, sondern bei einer bewussten Obergrenze. Vier Zahlen bei 2560: Anteil der Hülle am Fenster, Größe der Hauptüberschrift, Höhe der Kopfleiste, Höhe der Hauptschaltfläche. Sind die letzten drei dieselben wie bei 1280, gibt es oberhalb der letzten Bruchstelle keine Regel mehr. Ausgearbeitet in [`04_UI/08-grosse-bildschirme-und-obergrenzen.md`](04_UI/08-grosse-bildschirme-und-obergrenzen.md).
