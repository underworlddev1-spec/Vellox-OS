...
**Und lass die Seite auf großen Schirmen mitwachsen.** Das ist der Gegenpol zur Handy-Prüfung und ebenso leicht zu übersehen. Ein mobil-zuerst gebautes, an einer Maximalbreite gedeckeltes Layout hört an seinem letzten Breakpoint auf zu wachsen. Auf einem 1920- oder 2560-Monitor klebt der Inhalt dann in einer schmalen Spalte und wirkt zu klein, und im Bau sieht das niemand, weil zwischen 1280 und 1440 entwickelt wird. Weil Typografie, Abstände und Maximalbreiten in rem hängen, lässt eine fließende Wurzel-Schriftgröße das ganze System proportional mitwachsen. Zwei Bedingungen sind Pflicht: Die Untergrenze bleibt ein rem, damit kleine Schirme unverändert bleiben und eine größere Browser-Grundschrift erhalten bleibt, und die Breakpoints stehen in Pixeln, sonst verschieben sie sich mit der wachsenden Schrift. Ausgearbeitet in [`04_UI/08-grosser-bildschirm-und-skalierung.md`](04_UI/08-grosser-bildschirm-und-skalierung.md).
